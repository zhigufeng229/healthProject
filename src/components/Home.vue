<template>
    <el-container class="home-container">
      ...
      <el-header>
        <div>
          <img src="../assets/login_logo (2).png" alt class="logo_img" />
          <span>健康管理平台</span>
        </div>
        <el-button type="info" @click="logout" class="quit_btn">安全退出</el-button>
      </el-header>
      <el-container>
        <!--侧边布局-->
        <el-aside :width="isCollapse ?'64px':'200px'">
          ...
          <el-menu background-color="#b3c0d6" text-color="black" active-text-color="#409EFF" unique-opened :collapse="isCollapse" 
